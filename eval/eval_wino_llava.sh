    ...
    for lr in "${learning_rates[@]}"; do
        for lora_r in "${lora_rs[@]}"; do
            for scaling_factor in "${scaling_factors[@]}"; do
                ...
                MODEL_VERSION=bz_$bz-lr_$lr-lora_r_$lora_r-scaling_factor_$scaling_factor-new_data

                python seva/model_vqa_loader.py \
                    --model-path ./checkpoints/${MODEL_VERSION} \
                    --model-base /home/data/wyy/checkpoints/llava-v1.5-7b \
                    --question-file /home/data/wyy/projects/SeVa/seva/playground/data/eval/winoground/data/parsed_examples.jsonl \
                    --image-folder /home/data/wyy/projects/SeVa/seva/playground/data/eval/winoground/data/images \
                    --answers-file /home/data/wyy/projects/SeVa/seva/playground/data/eval/winoground/answers/${MODEL_VERSION}.jsonl \
                    --temperature 0 \
                    --conv-mode vicuna_v1
